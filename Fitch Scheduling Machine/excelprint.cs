...
// class Program
// {
//     static void Main(Course[,,] schedule2dArray)
//     {
...
//         Course[,] array2D = Flatten3DLayerTo2D(schedule2dArray);

//         // Print the 2D array
//         Print2DArray(array2D);

//         // Transpose the 2D array
//         Course[,] transposedArray = Transpose2DArray(array2D);
...
//     static Course[,] Flatten3DLayerTo2D(Course[,,] array3D)
//         {
//             int layers = array3D.GetLength(0);
//             int rows = array3D.GetLength(1);
//             int cols = array3D.GetLength(2);
...
//     static Course[,] Transpose2DArray(Course[,] array2D)
//         {
//             int rows = array2D.GetLength(0);
//             int cols = array2D.GetLength(1);

//             // Create a new array with transposed dimensions
//             Course[,] transposed = new Course[cols, rows];
...
//         static void Write2DArrayToCsv(Course[,] array, string filePath)
//         {
